...
function install_docker() {
    local SIGNED_BY="/etc/apt/keyrings/docker.asc"
    local DOCKER_DOWNLOAD_URL="https://download.docker.com/linux/debian/gpg"
    ...
    echo \
    "deb [arch=$ARCH signed-by=$SIGNED_BY] $DOCKER_DOWNLOAD_URL \
